...
<div class="controls">
<input type="text" placeholder="Nhập vào tên danh mục"  name="category" class="span8 tip" required>
</div>
</div>


<div class="control-group">
											<label class="control-label" for="basicinput">Mêu Tả</label>
											<div class="controls">
...
?>									
										<tr>
											...
											<a href="manage-category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Bạn có chắc là muốn xóa?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
