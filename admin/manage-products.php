...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Đã xóa sản phẩm thành công!!";
		  }
...
<?php $query=mysqli_query($con,"select products.*,category.categoryName from products join category on category.id=products.id_category ");
$cnt=1;
